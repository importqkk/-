...
<%-- 				<li><a href="${pageContext.request.contextPath}/review/list?type=member_id&keyword=${memberId}">상품리뷰</a></li> --%>
<%-- 				<li><a href="${pageContext.request.contextPath}/qa/list?type=member_id&keyword=${memberId}">상품문의</a></li> --%>
