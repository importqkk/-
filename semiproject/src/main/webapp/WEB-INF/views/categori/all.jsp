...
<script type="text/javascript">
	// "none"
	$(function() {
		$(".a-font-lightgrey").click(
				function() { // 회색글씨가 눌리면 
					$(".a-font-purple").removeClass("a-font-purple").addClass(
							"a-font-lightgrey"); // 보라글씨의 a-font-purple클래스를 지우고 a-font-lightgrey 클래스를 추가
	...
	<div class="container-1200">
		<div class="flex center">
			<a class="w-5 me-50 fas fa-solid fa-border-all purple-box" href="${pageContext.request.contextPath}/categori/all"></a>
			<a class="w-5 me-50 fas fa-light fa-face-smile" href="${pageContext.request.contextPath}/categori/tag1"></a> <a
				class="w-5 me-50 fas fa-light fa-weight-scale" href="${pageContext.request.contextPath}/categori/tag2"></a> <a
				class="w-5 me-50 fas fa-light fa-venus" href="${pageContext.request.contextPath}/categori/tag3"></a> <a
				class="w-5 me-50 fas fa-sharp fa-light fa-bolt-lightning"
				href="${pageContext.request.contextPath}/categori/tag4"></a> <a class="w-5 me-50 fas fa-thin fa-mars"
				href="${pageContext.request.contextPath}/categori/tag5"></a> <a class="w-5 me-50 fas fa-light fa-eye"
				href="${pageContext.request.contextPath}/categori/tag6"></a> <a class="w-5 me-50 fas fa-light fa-tooth"
				href="${pageContext.request.contextPath}/categori/tag7"></a> <a class="w-5 me-50 fas fa-light fa-bone"
				href="${pageContext.request.contextPath}/categori/tag8"></a>
		</div>
		<div class="flex center">
		...
		<div class="flex left grey-box mt-20 mb-10">
			<div class="flex w-70 ps-100">
				<a class="w-6 a-font-lightgrey oneLine">인기순</a> <a
					class="w-2 font-lightgrey oneLine">&nbsp;|</a> <a
					class="w-5 a-font-lightgrey oneLine">최신순</a> <a
					class="w-2 font-lightgrey oneLine">&nbsp;|</a> <a
					class="w-9 a-font-lightgrey oneLine">낮은가격순</a> <a
					class="w-2 font-lightgrey oneLine">|</a> <a
					class="w-9 a-font-lightgrey oneLine">높은가격순</a>
			</div>
			<div class="flex w-30 right pe-100">
				<h5 class="w-30 me-10 font-lightgrey">${count}개의제품</h5>
			</div>
		</div>
<!---------------------여기부터는 이미지 들의 리스트 ------------------->
		<!--인기상품 -->
